...
<details>
<summary><b>Show More Open-Source Contributions (Expand 14 Additional Tier-1 & Core Infrastructure PRs)</b></summary>
<br />
...
| **Google** (`adk-go`) | Agent Runtime | Recurse task_completed injection and rebind Agent in Run and RunLive | [#1510](https://github.com/google/adk-go/pull/1510) | <img src="https://img.shields.io/badge/In_Review-38bdf8?style=flat-square&logo=github&logoColor=white" alt="In Review" /> |
